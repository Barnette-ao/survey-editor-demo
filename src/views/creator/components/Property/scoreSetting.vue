		...
		<div class="setting-section">
			...
			<div class="section-content">
				<div class="setting-item">
					<span>最低分</span>
					<el-input-number v-model="rateMin" :min="0" size="small" controls-position="right" />
				</div>
				<div class="setting-item">
					<span>最高分</span>
					<el-input-number v-model="rateMax" :min="rateMin + 1" size="small" controls-position="right" />
				</div>
				<div class="setting-item">
					<span>量级刻度</span>
